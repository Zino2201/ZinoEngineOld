...
mkdir "Binaries\Debug Monolithic\" 2>NUL
...
copy "Sources\Libs\ShaderConductor\Build\vs2019-win-vc150-x64\Bin\Release\ShaderConductor.dll" "Binaries\Release Monolithic\ShaderConductor.dll"
copy "Sources\Libs\ShaderConductor\Build\vs2019-win-vc150-x64\Bin\Release\dxcompiler.dll" "Binaries\Release Monolithic\dxcompiler.dll"
