...
public:
	...
	const std::shared_ptr<IShaderAttributesManager>& GetShaderAttributesManager() const { return AttributeManager; }
private:
...
private:
	...
	std::shared_ptr<IShaderAttributesManager> AttributeManager;
};