...
CVulkanSampler::CVulkanSampler(CVulkanDevice* InDevice, const SRenderSystemSamplerInfo& InInfos) 
	: CRenderSystemSampler(InInfos), CVulkanDeviceResource(InDevice)
{
