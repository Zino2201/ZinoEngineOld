...
{	
	...
	robin_hood::unordered_map<ERenderPass, std::vector<size_t>> VisibleCachedDrawcalls;
	...
	robin_hood::unordered_map<ERenderPass, CRenderPassRenderer> RenderPassRendererMap;
