...
void PreInit()
{
	...
	/** INITIALIZE BASE MODULES */
	{
		...
		ZE::Module::LoadModule("EngineCore");
		...
		{
			if(!FS::Exists(Obj))
				ZE::Logger::Fatal("Can't find \"{}\" ! Can't continue", Obj);
		}

		ZE::Module::LoadModule("Reflection");
		...
		/** Load core modules */
		ZE::Module::LoadModule("Engine");

		/** Load render modules */
		ZE::Module::LoadModule("ShaderCore");
		ZE::Module::LoadModule("RenderCore");
		ZE::Module::LoadModule("RenderSystem");
		ZE::Module::LoadModule("ImGui");
		ZE::Module::LoadModule("ShaderCompiler");
	}

	/** INITIALIZE RENDER SYSTEM **/
	{
		ZE::Logger::Info("Initializing render system");
		ZE::Module::LoadModule("VulkanRenderSystem");
		ZE::Module::LoadModule("VulkanShaderCompiler");
