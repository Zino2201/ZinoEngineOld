...
mkdir Binaries\RelWithDebInfoMonolithic\ 2>NUL
...
copy Sources\Libs\ShaderConductor\Build\vs2019-win-vc142-x64\Bin\Release\ShaderConductor.dll Binaries\RelWithDebInfoMonolithic\ShaderConductor.dll
copy Sources\Libs\ShaderConductor\Build\vs2019-win-vc142-x64\Bin\Release\dxcompiler.dll Binaries\RelWithDebInfoMonolithic\dxcompiler.dll
